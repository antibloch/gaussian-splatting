...
```shell
# HTTPS
git clone https://github.com/antibloch/gaussian-splatting.git --recursive
```
...
```shell
# use pytorch with cuda according to cuda toolkit installed: https://pytorch.org/get-started/previous-versions/
...
### Get Poses from Video

```
python extract_frames.py --vid <name of video> --percent_frames 0.5
```


### Get Rail Masks (Experimental : Incomplete, Skip)
